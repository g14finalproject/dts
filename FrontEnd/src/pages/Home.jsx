...
import '../pages/main/assets/css/style-starter.css'
      ...
      <div className="mx-auto h-full flex items-center ">
        <div className="text-center">
          <div className="flex items-center w-[80%] m-auto flex-col md:flex-row ">
            <div>
              ...
              <h1 className="block text-3xl text-center  font-extrabold text-gray-900 sm:text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-10% to-purple-700 to-90%  p-2">
                DTS Event Organizers System
              </h1>
            </div>
            <img src="./images/home.jpg" className="h-[40%] w-[40%]" />
          </div>
          <p className="mt-8 text-md text-gray-600 max-w-3xl mx-4 md:mx-16 lg:mx-auto">
            ...
            authentication system by analyzing and confirming the  facial
